...
if [[ "$CURRENT_BRANCH" != "main" && "$CURRENT_BRANCH" != "production" ]]; then
    ...
    echo ""
    echo "To publish packages, you have three options:"
    echo ""
    ...
    echo "  - Select 'Publish npm to GitHub Packages' or 'Publish Docker Image'"
    echo "  - Click 'Run workflow' and select your branch"
    echo ""
...
if [[ "$1" == "--trigger" ]]; then
    ...
    echo "  gh run list --workflow=docker-publish.yml"
    echo ""
