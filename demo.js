...
console.log('\n👤 Creating entities:');
bae.addEntity('ung_self', { age: 'uth' });
...
const entities = ['ung_self', 'curiosity', 'data', 'learning', 'mathematics'];
console.log(`   Created ${entities.length} entities: ${entities.join(', ')}`);

// Create relationships
console.log('\n🔗 Creating relationships:');
bae.connect('ung_self', 'curiosity', 1.0);    // Perfect connection
...
bae.connect('ung_self', 'mathematics', 0.5);  // Growing connection

console.log('   ung_self ←→ curiosity: 1.0 (Perfect)');
...
for (const entity of ['ung_self', 'curiosity', 'data']) {
...
const transitive = bae.transitiveConnection('ung_self', 'learning');
console.log(`\n🔄 Transitive connection (ung_self → learning): ${transitive.toFixed(4)}`);
...
console.log('\n📖 The Story:');
console.log('   1. Started ung and curious about data');
