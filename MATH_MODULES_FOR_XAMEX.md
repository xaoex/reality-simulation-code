...
**Location:** `lib/yoshis-secret/`
**Files:**
- `lib/yoshis-secret/index.js` - Main implementation (~800 lines)
- `lib/yoshis-secret/README.md` - Documentation
...
**Tests:** 9 test functions (removed from test-young-field.js)
...
**Tests:** 12 test functions (removed from test-young-field.js)
...
**Tests:** 14 test functions (removed from test-young-field.js)
...
git --git-dir=/path/to/reality-simulation-code/.git show 82fa47d:lib/yoshis-secret/index.js > lib/yoshis-secret/index.js
git --git-dir=/path/to/reality-simulation-code/.git show 82fa47d:lib/yoshis-secret/README.md > lib/yoshis-secret/README.md
...
The math modules depend on Young Field for some operations. In xamex, you can either:
...
The test functions removed from `test-young-field.js` should be added to xamex's test suite:
